...
from ROTASK.datasets.ecg_data_model import ECGLeads
from ROTASK.datasets import ECGDataset
...
if __name__ == "__main__":
    ...
    config.stratify_attr = []
    config.train_test_patient_possible_overlap = True
    config.target_attr_transform = ECGDataset.transform_statements_cleansr
